...
export PKG_CONFIG_PATH="$PKG_CONFIG_PATH:/d/casadi-windows-matlab/ipopt-install/lib/pkgconfig:/d/coinhsl/lib/pkgconfig"
export PATH="/d/casadi-windows-matlab/ipopt-install/lib:/d/casadi-windows-matlab/lapack-install/lib:$PATH"
```
...
#newW
cmake -DCMAKE_TOOLCHAIN_FILE="/d/casadi-installation-files/toolchain-casadi.cmake" -DCMAKE_INSTALL_PREFIX="/d/casadi-windows-matlab/casadi-install" -DWITH_THREAD=ON -DWITH_COMMON=ON -DINSTALL_INTERNAL_HEADERS=ON -DWITH_OPENMP=ON -DWITH_SELFCONTAINED=ON -DWITH_DEEPBIND=ON -DWITH_MATLAB=ON -DSWIG_EXECUTABLE="/d/casadi-windows-matlab/swig-install/bin/swig" -DSWIG_DIR="/d/casadi-windows-matlab/swig-install/share/swig/3.0.11" -DWITH_BLASFEO=ON -DWITH_BUILD_BLASFEO=ON -DBLAS_LIBRARIES="blas" -Wno-dev -G "MSYS Makefiles" ..
...
/opt/casadi-linux-matlab/ipopt-install/lib
/opt/intel/mkl/lib/intel64//usr/lib/gcc/x86_64-linux-gnu/5
/usr/lib/x86_64-linux-gnu
/usr/lib/gcc/lib/lib
/usr/lib
/opt/intel/compilers_and_libraries_2019.4.243/linux/tbb/lib/intel64_lin/gcc4.7
...
## TRY THIS <https://github.com/xianyi/OpenBLAS>
```
